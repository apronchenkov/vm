...
static void u7_vm0_operation_add_i32_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
...
static void u7_vm0_operation_add_i64_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
...
static void u7_vm0_operation_add_f32_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
...
static void u7_vm0_operation_add_f64_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
...
struct u7_vm0_operation u7_vm0_operation_add_i32() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_add_i32_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_add_i64() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_add_i64_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_add_f32() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_add_f32_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_add_f64() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_add_f64_execute}};
  return result;
}

// print

static void u7_vm0_operation_print_i32_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
  printf("%" PRId32, u7_vm_stack_pop_i32(&state->stack));
}

static void u7_vm0_operation_print_i64_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
  printf("%" PRId64, u7_vm_stack_pop_i64(&state->stack));
}

static void u7_vm0_operation_print_f32_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
  printf("%f", u7_vm_stack_pop_f32(&state->stack));
}

static void u7_vm0_operation_print_f64_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
  printf("%f", u7_vm_stack_pop_f64(&state->stack));
}

static void u7_vm0_operation_println_execute(
    struct u7_vm_instruction const* self, struct u7_vm_state* state) {
  (void)self;
  (void)state;
  printf("\n");
...
struct u7_vm0_operation u7_vm0_operation_print_i32() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_print_i32_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_print_i64() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_print_i64_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_print_f32() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_print_f32_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_print_f64() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_print_f64_execute}};
  return result;
}

struct u7_vm0_operation u7_vm0_operation_println() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_println_execute}};
  return result;
}

// yield

static void u7_vm0_operation_yield_execute(struct u7_vm_instruction const* self,
...
struct u7_vm0_operation u7_vm0_operation_yield() {
  struct u7_vm0_operation result = {
      .base = {.execute_fn = u7_vm0_operation_yield_execute}};
  return result;
}
